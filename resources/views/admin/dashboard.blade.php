...
<section class="admin-card professional-card">
    ...
    <div class="admin-stats-grid">
        ...
        @if(\Illuminate\Support\Facades\Route::has('admin.site-pages.index'))
            <a href="{{ route('admin.site-pages.index') }}">
                <span>Site Pages</span>
                <b>{{ \App\Models\SitePage::count() }}</b>
            </a>
        @endif

        @if(\Illuminate\Support\Facades\Route::has('admin.contact-messages.index'))
            <a href="{{ route('admin.contact-messages.index') }}">
                <span>Contact Messages</span>
                <b>{{ \App\Models\ContactMessage::where('status', 'new')->count() }}</b>
            </a>
        @endif
    </div>
</section>
