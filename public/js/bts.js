...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        setupUpdateSharing();
        setupPhoneGallery();
        setupNavbarPointerGlow();
        setupCmsPageInteractions();
    });
    ...
    function setupNavbarPointerGlow() {
        const buttons = document.querySelectorAll('.site-nav a, .nav-cta, .nav-link-button');
    ...
    function setupCmsPageInteractions() {
