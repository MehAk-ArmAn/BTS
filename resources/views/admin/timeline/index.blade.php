...
<section class="admin-card professional-card">
    ...
    <form method="POST" action="{{ route('admin.timeline.store') }}" enctype="multipart/form-data" class="admin-grid-form">
        @csrf
...
<section class="admin-card professional-card">
    <form method="POST" action="{{ route('admin.timeline.update', $event) }}" enctype="multipart/form-data" class="admin-grid-form">
        @csrf @method('PUT')
